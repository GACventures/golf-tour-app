    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200">
        <div className="h-12 px-3 flex items-center">
          ...
          <div className="flex-1 text-center font-semibold">Round results</div>
      ...
      <div className="px-4 py-6 max-w-md mx-auto">
        <div className="rounded-xl border border-gray-200 p-4 shadow-sm">
          <div className="text-sm text-gray-600">
            Placeholder page: <span className="font-medium">Round results</span>
          </div>
          <div className="text-xs text-gray-500 mt-2">
            We’ll implement the actual results UI next using the same mock → full-file methodology.
          </div>
        </div>
      </div>
    </div>
